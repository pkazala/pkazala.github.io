Create one horizontal animation strip for Codex pet `sakura`, state `running-right`.
...
Identity: same pet in every frame: Compact full-body white maneki-neko lucky cat; soft ceramic-toy styling; warm friendly face; red collar with a small attached gold bell; one raised beckoning paw; a single readable pink sakura blossom tucked behind one ear; no coin, text, floor, shadow, or detached decoration.. Preserve silhouette, face, proportions, markings, palette, material, style, and props.
Style: Pet-safe sprite: compact full-body mascot, readable in a 192x208 cell, clear silhouette, simple face, stable palette/materials, and crisp edges for chroma-key extraction. Style `3d-toy`: Stylized 3D toy mascot with smooth rounded forms, simple materials, clear silhouette, and no photoreal complexity. User style notes: Quiet polished collectible-toy look, rounded forms, subtle cream shading, crisp pet-sized details, consistent sakura accessory..
